...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": активуйте щоб відсортувати значення за зростанням",
                sSortDescending: ": активуйте щоб відсортувати значення за спаданням"
            },
            oPaginate: {sFirst: "Перший", sLast: "Останній", sNext: "Наступна", sPrevious: "Попередня"},
            sEmptyTable: "Дані таблиці відсутні",
            sInfo: "Відображено _START_ - _END_ із _TOTAL_ записів",
            sInfoEmpty: "Відоражено 0 - 0 із 0 записів",
            sInfoFiltered: "(відібрано із _MAX_ записів)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Відобразити _MENU_ записів",
            sLoadingRecords: "Завантаження...",
            sProcessing: "Процессінг...",
            sSearch: "Знайти:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Даних за запитом не знайдено"
        },
        oSearch: h.extend({},
            n.models.oSearch),
        sAjaxDataProp: "data",
